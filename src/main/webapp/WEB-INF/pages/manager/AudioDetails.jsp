        ...
        function () {
            var table = layui.table,
                ...
                tableIns = table.render({
                    ...
                    height: 'full-200',
                    cellMinWidth: 80,
                    url: 'http://localhost:8848/English/resource/queryAllaudio' //数据接口
                    ,
                    title: '用户表',
                    page: true, //开启分页
                    ...
                    cols: [
                        [ //表头
                            ...
                            templet: function (res) {
                                return "<audio controls style='height: 30px;'> <source src='" + res.url + "' type='audio/mpeg'>"
                            },
                            width: 350
                        }, {
                            field: 'type',
            ...
            $("#search").on("click", function () {
                tableIns.reload({
                    url: "http://localhost:8848/English/resource/queryaudioByLike",
                    where: {
